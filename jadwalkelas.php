...
<nav class="navbar navbar-expand-lg">
    ...
    <?php 
    echo "<h1>Jadwal Kelas " . $selectedSchedule['nama_kelas']."</h1>";
    echo "<table>";
    echo "<tr>";
    echo "<th>Nama Pelajaran</th>";
    echo "<th>Keterangan Pelajaran</th>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>".$selectedSchedule['nama_pelajaran']."</td>";
    echo "<td>".$selectedSchedule['ket_pelajaran']."</td>";
    echo "</tr>";
    echo "</table>";
