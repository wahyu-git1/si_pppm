...
<body>
    ...
    <a href="tambah_data_santri_admin.php"><button class="btn btn-success" type="button">Tambah User</button></a>
    <table class="table">
        <thead>
            <tr>
                <th scope="col">ID</th>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <a href="delete_data_santri_admin.php?id=<?php echo $row['id_santri']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
